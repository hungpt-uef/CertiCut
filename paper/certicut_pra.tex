...
In accordance with APS policy, the authors disclose that generative AI assistants (Claude 3.7 Sonnet and OpenAI GPT-4o) were used to assist in implementing and debugging experiment and analysis code; all code, results, and manuscript content were reviewed, verified, and validated by the authors, who take full responsibility for the work.
\end{acknowledgments}
